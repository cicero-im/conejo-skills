...
_The CodeRabbit-powered local review engine that conejo-merge and conejo-debug wrap.
Merged from the former `code-review` skill._

AI-powered code review using CodeRabbit. Enables developers to implement features,
review code, and fix issues in autonomous cycles without manual intervention.
...
- **auto-apply CodeRabbit review comments** — see `autofix.md` in this folder.
