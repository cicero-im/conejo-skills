...
_The apply-side of the review cycle. Pairs with `coderabbit-engine.md` and conejo-merge's
Calm Implement mode. Merged from the former `autofix` skill._
...
- Threads: `gh api graphql ... pullRequest.reviewThreads ...`
...
- **CodeRabbit-powered local review** — see `coderabbit-engine.md` in this folder.
